...
class FuncionarioRepository extends FilterRepository
{
    ...
    {
        $ql = "SELECT f FROM CrosierSource\CrosierLibRadxBundle\Entity\RH\Funcionario f JOIN CrosierSource\CrosierLibRadxBundle\Entity\RH\FuncionarioCargo fc WHERE fc.funcionario = f AND f.codigo = :codigo AND fc.atual = TRUE";
