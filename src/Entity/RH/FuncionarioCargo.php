...
/**
 *
 * @ORM\Entity(repositoryClass="CrosierSource\CrosierLibRadxBundle\Repository\RH\FuncionarioCargoRepository")
...
class FuncionarioCargo implements EntityId
{
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="CrosierSource\CrosierLibRadxBundle\Entity\RH\Cargo")
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="CrosierSource\CrosierLibRadxBundle\Entity\RH\Funcionario", inversedBy="cargos")
